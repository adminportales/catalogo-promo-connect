        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="image_url" type="text" class="form-control" id="image_url" placeholder="Image Url">@error('image_url') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
