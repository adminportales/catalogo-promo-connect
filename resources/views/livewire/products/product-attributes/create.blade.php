    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Product Attribute</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="attribute" type="text" class="form-control" id="attribute" placeholder="Attribute">@error('attribute') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
